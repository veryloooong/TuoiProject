...
INSERT INTO courses(id, title, provider, description, price)
VALUES (
    1,
    'Khóa 1',
    'Tưới SoFund',
...
VALUES (
    ...
    'Khóa 3',
    'Dự án ABC',
    'Sed finibus eros a enim pretium, quis cursus mi lacinia. Nam ex mi, volutpat quis congue id, dignissim eu ipsum. Aenean quis augue nec ante dapibus pretium. Vestibulum ac congue sem. Cras mattis condimentum nunc, et laoreet elit porttitor viverra. Cras dictum blandit mi, at accumsan felis tempor sit amet. Nulla sagittis nisi ut leo cursus, non rutrum nisi auctor. Aliquam volutpat pretium magna, et ornare felis ornare vitae.',
    10000000
  );